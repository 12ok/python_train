...
def verify_group_added(db, group_list, new_group):
    ...
    assert sorted(map(clear, old_groups), key=Group.id_or_max) == sorted(map(clear, new_groups), key=Group.id_or_max)


@then('the new list is equals to the old list without the delete group')
